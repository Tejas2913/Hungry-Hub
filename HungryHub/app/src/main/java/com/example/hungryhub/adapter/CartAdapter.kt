...
class CartAdapter(
    ...
    private val cartNutrient: MutableList<String>,
    private val uniqueKeys: List<String>
    ...
    inner class CartViewHolder(private val binding: CartItemBinding) :
        ...
        private fun deleteItem(position: Int) {
            val uniqueKey = uniqueKeys[position] // Get the unique key for the item at this position
        ...
        private fun removeItem(position: Int, uniqueKey: String) {
            cartItemsReference.child(uniqueKey).removeValue()
                .addOnSuccessListener {
                    ...
                    cartNutrient.removeAt(position)
